...
/obj/item/reagent_containers/hypospray/medipen/examine()
	...
	if(length(reagents?.reagent_list))
		...
		. += "<span class='notice'>Theres a small holowarning on the side which reads, 'WARNING: This [src] contains [reagent_text]. Do not use if allergic to any listed chemicals.' in small text.</span>"
	else
		. += "<span class='notice'>Theres an empty holoscreen on the side.</span>"
