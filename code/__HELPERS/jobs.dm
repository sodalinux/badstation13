...
/proc/get_department_by_access(access)
	/var/static/access_to_department = list(
		// SEC
		ACCESS_SECURITY = ACCOUNT_SEC,
		ACCESS_BRIG = ACCOUNT_SEC,
		ACCESS_ARMORY = ACCOUNT_SEC,
		ACCESS_FORENSICS_LOCKERS = ACCOUNT_SEC,
		ACCESS_BRIGPHYS = ACCOUNT_SEC,  // bphys office in sec
		ACCESS_COURT = ACCOUNT_SEC,
		ACCESS_HOS = ACCOUNT_SEC,

		// MED
		ACCESS_MEDICAL = ACCOUNT_MED,
		ACCESS_MORGUE = ACCOUNT_MED,
		ACCESS_GENETICS = ACCOUNT_MED,
		ACCESS_CREMATORIUM = ACCOUNT_MED,
		ACCESS_CHEMISTRY = ACCOUNT_MED,
		ACCESS_VIROLOGY = ACCOUNT_MED,
		ACCESS_CMO = ACCOUNT_MED,
		ACCESS_SURGERY = ACCOUNT_MED,

		// SCI
		ACCESS_TOX = ACCOUNT_SCI,
		ACCESS_TOX_STORAGE = ACCOUNT_SCI,
		ACCESS_ROBOTICS = ACCOUNT_SCI,
		ACCESS_RD = ACCOUNT_SCI,
		ACCESS_XENOBIOLOGY = ACCOUNT_SCI,
		ACCESS_RD_SERVER = ACCOUNT_SCI,

		// ENG
		ACCESS_CONSTRUCTION = ACCOUNT_ENG,
		ACCESS_AUX_BASE = ACCOUNT_ENG,
		ACCESS_MAINT_TUNNELS = ACCOUNT_ENG,
		ACCESS_ENGINE = ACCOUNT_ENG,
		ACCESS_ENGINE_EQUIP = ACCOUNT_ENG,
		ACCESS_EXTERNAL_AIRLOCKS = ACCOUNT_ENG,
		ACCESS_TECH_STORAGE = ACCOUNT_ENG,
		ACCESS_ATMOSPHERICS = ACCOUNT_ENG,
		ACCESS_MECH_ENGINE = ACCOUNT_ENG,
		ACCESS_TCOMSAT = ACCOUNT_ENG,
		ACCESS_MINISAT = ACCOUNT_ENG,
		ACCESS_CE = ACCOUNT_ENG,

		ACCESS_MAILSORTING = ACCOUNT_CAR,
		ACCESS_MINING = ACCOUNT_CAR,
		ACCESS_MINING_STATION = ACCOUNT_CAR,
		ACCESS_MECH_MINING = ACCOUNT_CAR,
		ACCESS_MINERAL_STOREROOM = ACCOUNT_CAR,
		ACCESS_CARGO = ACCOUNT_CAR,
		ACCESS_QM = ACCOUNT_CAR,
		ACCESS_VAULT = ACCOUNT_CAR,

		ACCESS_HEADS = "COM",
		ACCESS_RC_ANNOUNCE = "COM",
		ACCESS_KEYCARD_AUTH = "COM",
		ACCESS_CHANGE_IDS = "COM",
		ACCESS_AI_UPLOAD = "COM",
		ACCESS_TELEPORTER = "COM",
		ACCESS_EVA = "COM",
		ACCESS_GATEWAY = "COM",
		ACCESS_ALL_PERSONAL_LOCKERS = "COM",
		ACCESS_HOP = "COM",
		ACCESS_CAPTAIN = "COM",
		ACCESS_VAULT = "COM"
	)
	return access_to_department[access] || ACCOUNT_CIV
